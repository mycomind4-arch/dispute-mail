export type WorkflowId = "credit-report" | "debt-validation" | "billing-error" | "unauthorized-charge";

export type WorkflowStep = "intro" | "document" | "facts" | "objective" | "analysis" | "evidence" | "strategy" | "draft" | "review" | "attachments" | "recipient" | "mailing" | "checkout" | "submitted";
