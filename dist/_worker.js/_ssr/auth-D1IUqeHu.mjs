...
import { A as ArrowRight, E as CircleCheck, x as FileExclamationPoint } from "../_libs/lucide-react.mjs";
import { i as SiteHeader, r as SiteFooter } from "./router-B6Kjj9WG.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/auth-D1IUqeHu.js
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
									...
									style: { fontFamily: "var(--font-serif)" },
									children: "Your disputes, organized and sent."
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-4 text-sm leading-7 text-white/60",
									children: "Create an account to save drafts, track mailings, and keep a permanent record of your dispute filings."
								}),
							...
							children: submitted ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									disabled: !email.trim(),
									className: "btn-rose mt-5 w-full justify-center",
