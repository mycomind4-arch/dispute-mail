...
import { A as ArrowRight, O as Check, T as Clock, a as Stamp, c as ShieldCheck, g as Mail, p as PackageCheck, s as Shield } from "../_libs/lucide-react.mjs";
import { i as SiteHeader, r as SiteFooter } from "./router-DFuyLIZY.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/pricing-C_pYymD9.js
var import_jsx_runtime = require_jsx_runtime();
var tiers = [
	{
		type: "First-Class",
		price: "$3.99",
		desc: "Standard delivery for non-urgent disputes",
		features: [
			"3–5 business days",
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: tiers.map(({ type, price, desc, features, icon: Icon, featured }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: `card p-6 ${featured ? "ring-2 ring-rose-400" : ""}`,
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-4 text-4xl font-bold text-teal-700",
										style: { fontFamily: "var(--font-serif)" },
										children: price
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
										...
										className: `mt-6 w-full justify-center text-center ${featured ? "btn-rose" : "btn-primary"}`,
