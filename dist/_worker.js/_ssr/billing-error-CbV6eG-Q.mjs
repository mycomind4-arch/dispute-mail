...
//#region node_modules/.nitro/vite/services/ssr/assets/billing-error-CbV6eG-Q.js
...
function BillingError() {
	...
	const [providerName, setProviderName] = (0, import_react.useState)("");
	const [billType, setBillType] = (0, import_react.useState)("");
	const [accountNumber, setAccountNumber] = (0, import_react.useState)("");
	const [billDate, setBillDate] = (0, import_react.useState)("");
	const [disputedAmount, setDisputedAmount] = (0, import_react.useState)("");
							...
							children: [
								step === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
										...
										children: "Dispute a billing error"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-4 leading-7 text-slate-400",
										children: "We'll help you identify the incorrect charges, state the facts, prepare an editable dispute letter, and move toward mailing."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											" Medical billing errors are common. Check for duplicate charges, services not received, and incorrect billing codes."
										]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-6 grid gap-3 sm:grid-cols-2",
										children: [
											"Identify the provider and bill",
											"State what charges are wrong",
								...
								step === 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
										...
										style: { fontFamily: "var(--font-serif)" },
										children: "Start with the bill"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-slate-400",
										children: "Upload the bill or identify the key details."
									}),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
												...
												children: "Provider / company name *"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
												className: "input-field",
												value: providerName,
												onChange: (e) => setProviderName(e.target.value),
												placeholder: "Hospital, utility, service provider"
											})] }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
												className: "input-label",
												children: "Bill type"
												...
												placeholder: "Medical, utility, subscription, etc."
											})] }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
												className: "input-label",
								...
								step === 2 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
										className: "mt-3 text-2xl font-bold text-teal-700",
										style: { fontFamily: "var(--font-serif)" },
										children: "What charges are wrong?"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-slate-400",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "alert alert-info mt-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Tip:" }), " Reference specific line items, dates of service, and billing codes. Explain exactly why each charge is incorrect."]
									})
								] }),
								step === 3 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
										...
										placeholder: "Example: I want the duplicate charges removed and a corrected bill issued."
									})
								] }),
								...
								step === 6 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-slate-400",
										children: "Attach the bill, EOBs, receipts, or records supporting your dispute."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "mt-1 block text-sm text-slate-300",
												children: "Bill, EOB, receipts, correspondence"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
												type: "file",
												accept: "application/pdf,image/jpeg,image/png",
								...
								step === 7 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-slate-400",
										children: "Enter the provider's billing department address."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "mt-6 grid gap-4 sm:grid-cols-2",
										children: [
								...
								step === 8 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-slate-400",
										children: "For billing disputes, certified mail provides proof of timely submission."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-6 grid gap-3 sm:grid-cols-2",
								...
								step === 10 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "mt-3 text-slate-400",
											children: "Your billing dispute letter is being prepared for mailing."
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
//#endregion
export { BillingError as component };
