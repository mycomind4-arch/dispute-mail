...
import { A as Check, D as Clock, F as ArrowLeft, O as CircleCheck, P as ArrowRight, h as PackageCheck, o as Stamp, u as ShieldAlert, v as Mail, x as FileUp, y as Lock } from "../_libs/lucide-react.mjs";
import { i as SiteHeader, r as SiteFooter } from "./router-Ch5bc3-4.mjs";
import { t as workflows } from "./workflows-B0kN1LGS.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/credit-report-BhH1LvDD.js
...
function CreditReport() {
	...
	const [submissionStatus, setSubmissionStatus] = (0, import_react.useState)("not_ready");
							...
							children: [
								...
								step === 9 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lock, {
											size: 16,
											className: "shrink-0"
										}), " Live payment and physical-mail submission are not wired into this workflow yet. No payment or mailing will be initiated from this page."]
									}),
									submissionStatus === "blocked" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-3 text-sm font-semibold text-slate-500",
										children: "Submission is blocked until the authenticated payment, fulfillment, tracking, and proof path is installed."
									})
								] }),
								step === 10 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
											...
											style: { fontFamily: "var(--font-serif)" },
											children: "Workflow complete"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "mt-3 text-slate-400",
											children: "The draft workflow has completed preparation and review. No physical mailing was initiated by this UI."
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								step < 10 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										...
										className: "btn-primary",
										children: [
											step === 9 ? "Payment + mailing integration required" : "Continue",
											" ",
