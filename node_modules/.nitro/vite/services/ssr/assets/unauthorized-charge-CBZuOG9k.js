...
//#region src/routes/workflows/unauthorized-charge.tsx?tsr-split=component
var stepLabels = [
	"Start",
	"Charge",
	"Facts",
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								step === 2 && /* @__PURE__ */ jsxs(Fragment, { children: [
									...
									/* @__PURE__ */ jsxs("div", {
										className: "alert alert-info mt-4",
										children: [/* @__PURE__ */ jsx("strong", { children: "Tip:" }), " Include when you noticed the charge, whether you authorized it, and whether you've already contacted the issuer. Reference the merchant name and amount."]
									})
								] }),
