import { i as SiteHeader, r as SiteFooter } from "./router-RzXvS3pE.js";
import { t as workflows } from "./workflows-DkkQ4FvX.js";
...
//#region src/routes/workflows/billing-error.tsx?tsr-split=component
var stepLabels = [
	"Start",
	"Bill",
	"Facts",
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								step === 2 && /* @__PURE__ */ jsxs(Fragment, { children: [
									...
									/* @__PURE__ */ jsxs("div", {
										className: "alert alert-info mt-4",
										children: [/* @__PURE__ */ jsx("strong", { children: "Tip:" }), " Reference specific line items, dates of service, and billing codes. Explain exactly why each charge is incorrect."]
									})
								] }),
