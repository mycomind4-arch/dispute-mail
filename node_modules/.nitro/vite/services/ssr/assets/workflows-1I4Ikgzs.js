...
import { ArrowRight, Building2, CreditCard, FileText, FileWarning, ReceiptText, ShieldCheck, Stethoscope } from "lucide-react";
//#region src/routes/workflows/index.tsx?tsr-split=component
var groups = [
	{
		...
		children: [
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs(Link, {
								...
								className: "btn-rose",
								children: ["Start a dispute ", /* @__PURE__ */ jsx(ArrowRight, { size: 18 })]
							}), /* @__PURE__ */ jsx(Link, {
								to: "/",
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsx("div", {
					...
					children: groups.map((group) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
						className: "max-w-2xl",
						children: [/* @__PURE__ */ jsx("div", {
							className: "eyebrow",
						...
						children: group.items.map(({ title, intent, description, href, icon: Icon }) => /* @__PURE__ */ jsxs(Link, {
							to: href,
							...
							children: [
								...
								/* @__PURE__ */ jsxs("span", {
									...
									children: ["Open workflow ", /* @__PURE__ */ jsx(ArrowRight, {
										size: 16,
