...
//#region src/routes/workflows/debt-validation.tsx?tsr-split=component
var stepLabels = [
	"Start",
	"Debt",
	"Facts",
							...
							children: [
								...
								step === 2 && /* @__PURE__ */ jsxs(Fragment, { children: [
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("strong", { children: "Tip:" }), " Include whether you recognize the debt, the original creditor if known, and any discrepancies in the amount or account details."]
									})
								] }),
